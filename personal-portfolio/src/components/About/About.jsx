    ...
    <section className={styles.container} id="about">
        <h2 className={styles.title}>About Me</h2>
            ...
            <div className={styles.aboutList}>
                ...
                <p className={styles.aboutItem}>I was awarded NSERC and worked on reinforcement learning research at the University of Alberta supervised by Michael Bowling. Through various machine learning projects, I have gained experience in data analysis, deep learning networks, and even some visualizations using Unity! This year, I am eager to continue diversifying my skill set further with computer graphics research in physics-base animation at the University of Toronto with David Levin.</p>
            </div>
        </div>
    </section>
  )
