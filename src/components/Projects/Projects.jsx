    ...
    const projects = [
        ...
        },
        {
            ...
            "details": ["I have a lot of programming experience so I was thrilled to see the other side of game design through art and music. My roles in this project was as 3D artist, animator, and sound designer.",
                "I previously had minimal experience in 3D modeling and animation, with my only experience being through a computer graphics course I took in third year. It was definitely a challenge at first, learning how the Blender animator works and how to rig models. However, I was able to learn quickly and create a variety of assets such as weapons, character, and environment models. I also created first-person shooter animations such as walking and shooting.",
                "As this is a rhythm game, I also composed a simple soundtrack and sound effects for the game. Although I have been performing in orchestras, my entire life, this was my first time composing digital music."
            ],
        },
        {
            "title": "Heart Beatz",
            ...
            "details": ["As I started computer science in university with no prior experience, I went into many hackathons in my second year with the goal of exploring a new area. This was my first time working with hardware and an Arduino. I worked with 3 other teammates to build a heart rate monitor that plays music based on your heart rate.",
                "My main role was with the hardware, working with the Arduino and a sensor to read data. Challenges came when we had insufficient hardware such as an SD card reader and we tried improvising with the pieces we had, using an SD card reader from an attachable screen. Unfortunately that aspect did not work but I learned a lot about how building hardware projects work.",
            ],
        },
        {
            "title": "Neom",
