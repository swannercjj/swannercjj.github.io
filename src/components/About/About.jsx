  ...
  return (
    <section className={styles.container} id="about">
        <h2 className={styles.title}>About Me</h2>
            ...
            <img src={cherryBlossoms} alt="cherry blossoms" className={styles.aboutImg}/>
            <div className={styles.aboutList}>
                ...
                <p className={styles.aboutItem}>I was awarded NSERC USRA scholarship and worked on reinforcement learning research at the University of Alberta supervised by Michael Bowling. Throughout my studies, I gained experience in machine learning, game development, and even quantitative finance. This year, I am eager to continue diversifying my skill set further with physics-based animation at the University of Toronto with David Levin.</p>
            </div>
        </div>
    </section>
  )
